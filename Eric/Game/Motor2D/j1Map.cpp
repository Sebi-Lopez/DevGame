...
void j1Map::Draw()
{
	...
	for (tileset_item; tileset_item != nullptr; tileset_item = tileset_item->next) 
	{
		for (layers_item; layers_item != nullptr; layers_item = layers_item->next)
		{
			for (uint x = 0; x < data.width; x++)
			{
				...
				for (uint y = 0; y < data.height; y++)
				{
					...
					//App->render->Blit(tileset_item->data->texture, world_coords.x, world_coords.y, &rect);ç
					if (layers_item->data->name == "cielo") {
						App->render->Blit(tileset_item->data->texture, world_coords.x, world_coords.y, &rect);
					}
					/*if (layers_item->data->name == "arboles1")
					{
						App->render->Blit(tileset_item->data->texture, world_coords.x, world_coords.y, &rect);
					}
					if (layers_item->data->name == "arboles2") {
						App->render->Blit(tileset_item->data->texture, world_coords.x, world_coords.y, &rect);
					}
					if (layers_item->data->name == "arboles3")
					{
						App->render->Blit(tileset_item->data->texture, world_coords.x, world_coords.y, &rect);
					}
					if (layers_item->data->name == "arboles4") {
						App->render->Blit(tileset_item->data->texture, world_coords.x, world_coords.y, &rect);
					}
					if (layers_item->data->name == "arboles5")
					{
						App->render->Blit(tileset_item->data->texture, world_coords.x, world_coords.y, &rect);
					}
					if (layers_item->data->name == "luces")
					{
						App->render->Blit(tileset_item->data->texture, world_coords.x, world_coords.y, &rect);
					}
					if (layers_item->data->name == "arbustos")
					{
						App->render->Blit(tileset_item->data->texture, world_coords.x, world_coords.y, &rect);
					}
					if (layers_item->data->name == "yerba1")
					{
						App->render->Blit(tileset_item->data->texture, world_coords.x, world_coords.y, &rect);
					}
					if (layers_item->data->name == "yerba2")
					{
						App->render->Blit(tileset_item->data->texture, world_coords.x, world_coords.y, &rect);
					}*/
					if (layers_item->data->name == "platforms")
					{
						App->render->Blit(tileset_item->data->texture, world_coords.x, world_coords.y, &rect);
					}
				}
...
iPoint j1Map::MapToWorld(int x, int y) const
{
	...
	case MAPTYPE_ISOMETRIC:
		ret.x = x * data.tile_width * 0.5 - y * data.tile_width * 0.5;
		ret.y = x * data.tile_height * 0.5 + y * data.tile_height * 0.5;
		break;
...
iPoint j1Map::WorldToMap(int x, int y) const
{
	...
	case MAPTYPE_ISOMETRIC:
		ret.x = ((x / (data.tile_width*0.5)) + (y / (data.tile_height*0.5))) / 2;
		ret.y = (y / (data.tile_height*0.5)) - ret.x;
		break;
...
SDL_Rect TileSet::GetTileRect(int id) const
{
	...
	// TODO 7(old): Create a method that receives a tile id and returns it's Rectint relative_id = id - firstgid;
